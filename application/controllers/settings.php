...
class Settings extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model(array('m_auth','m_settings'));
    }
    ...
    function index(){
        if (!$this->ion_auth->logged_in()){
            ...
            $this->layout->add_includes('js', 'themes/general/bundle/jquery_validation/jquery.validate.min.js','header');
            ...
            $this->layout->back('settings/index', $data);
        }
