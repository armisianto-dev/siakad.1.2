    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header ">
          ...
          <a style="height:100%;padding:9px 10px;" class="btn btn-sm btn-primary btn-flat pull-right" href="<?= site_url('siswa/cetak/'.$row['NIS']) ?>"><span class="glyphicon glyphicon-print"></span>&nbsp;Cetak</a>&nbsp;&nbsp;
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="pull-left">
                              <?= anchor('profilsiswa/cetakraport/' . $row['NIS'] . '/1/'.$row['thn'].'', 'Semester 1', 'class="label label-info" title="Raport semester 1"') ?>
                              <?= anchor('profilsiswa/cetakraport/' . $row['NIS'] . '/2/'.$row['thn'].'', 'Semester 2', 'class="label label-info" title="Raport semester 2"') ?>
                      </span>
                    </td>
                  </tr>
                  <?php
