    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive"  style="width:80%;">
                ...
                <?= form_open('raport/save', array('id' => 'form-tambah', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
                <?php
                ...
                <div class="form-group">
                    ...
                    <input class="form-control input-sm datepicker" name="tgl" type="text" placeholder="Tanggal Raport" style="max-width: 300px;">
                    </div>
                </div>
                <div class="form-group">
                    <label>Catatan Raport</label>
                    <textarea name="catatan" class="form-control input-sm" rows="5" style="max-width: 300px;"></textarea>
                </div>
                <?php
                    if ($sem==1) {
                        echo '<input type="hidden" name="keputusan" value="belum"/>';
                    }else{
