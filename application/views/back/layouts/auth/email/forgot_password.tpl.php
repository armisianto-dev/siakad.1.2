...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Lupa Kata Sandi &bull; <?php echo $this->config->item('site_title', 'ion_auth'); ?></title>
        <style type="text/css">
            /* RESET STYLES */
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" class="textContent">
                                                                                    <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                        Verifikasi lupa Kata Sandi pada <?php echo $this->config->item('site_title', 'ion_auth'); ?>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" valign="top" class="textContent">
                                                                        ...
                                                                        <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;"><?php echo $this->config->item('site_title', 'ion_auth'); ?></h2>
                                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Seseorang telah meminta untuk memulihkan Kata Sandi akun <?php echo $this->config->item('site_title', 'ion_auth'); ?> dengan <?php echo $this->config->item('identity', 'ion_auth'); ?> <b><?php echo $identity;?></b>, namun jika Anda tidak merasa memintanya cukup abaikan saja email ini, dan akun Anda akan tetap aman.</div>
