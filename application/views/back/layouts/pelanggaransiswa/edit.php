    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit Pelanggaran Siswa</h3>
            </div>
            <?= form_open('pelanggaransiswa/update', array('id' => 'form-tambah', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
            <div class="box-body">                      
               <table class="table table-borderless" style="width:40%;">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control input-sm datepicker" name="tgl" type="text" value="<?=$row['TGL']?>" placeholder="Tanggal Pelanggaran" style="max-width: 500px;">
                    </div>
                </div>
                <div class="form-group">
                    <label>Keterangan</label>

                    <textarea class="form-control" style="max-width: 500px;" name="ket" rows="4">
                        <?=$row['ket']?>
                    </textarea>
                </div>
