                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <span class="btn-group btn-group-justified" role="group">
                                        ...
                                        <?= anchor('catatanaspek/detail/' . $row['ID'] .'/'. $value['ID'] . '', 'Detail', 'class="btn btn-info btn-flat btn-sm" title="Detail Nilai"') ?>
                                        <?= anchor('catatanaspek/add/' . $row['ID'] .'/'. $value['ID'] . '', 'Tambah Catatan', 'class="btn btn-success btn-flat btn-sm" title="Tambah Nilai"') ?>
                                    </span>
                                <?php } ?>
                                </td>
                            </tr>
