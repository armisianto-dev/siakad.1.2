        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive" style="width:100%;">
             <?php
                $semester=$sem['value'];
             ?>
             <?= form_open('nilai/save', array('id' => 'form-tambah', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
               <table class="table table-borderless col-md-6" style="width:50%;">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                        <span class="badge bg-yellow"><?=$akhir+1;?></span>
                    ...
                    if (!empty($list)) {
                        ...
                        foreach ($list as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control input-sm" name="nilai<?=$no?>" value="0">
                                </td>
                            </tr>
                            <?php
                        }
                ...
                <input type="hidden" name="ke" value="<?=$akhir+1;?>">
            <?= form_close(); ?>
