                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="pull-right">
                                        <?= anchor('bagikelas/detail/' . $row['ID'] . '', 'Detail', 'class="label label-info" title="Detail Kelas"') ?>
                                        <?php
                                        foreach ($user_groups as $value) {
                                            if($value->name=="admin"){?>
                                        <?= anchor('bagikelas/add/' . $row['ID'] . '', 'Tambah Siswa', 'class="label label-success" title="Tambah Siswa"') ?>
                                        <?php }} ?>
                                    </span>
                                </td>
                            </tr>
