    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Tambah Siswa Ekstrakulikuler</h3>
            ...
            <div class="box-body table-responsive"  style="width:80%;">
                ...
                <?= form_open('siswaeskul/save', array('id' => 'form-tambah', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
                <table id="tartikel" class="table table-border table-hover table-condensed">
                    <input type="hidden" name="ideskul" value="<?= $id ?>">
