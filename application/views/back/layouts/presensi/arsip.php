    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <span class="box-title">Arsip Presensi</span>
            </div><!-- /.box-header -->
                ...
                <table id="tartikel" class="table table-bordered table-hover table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th width="5%">NIS</th>
                            <th width="35%">Nama</th>
                            <th width="12%">Jumlah Ketidakhadiran</th>
                            <th width="5%">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="pull-right">
                                        <?= anchor('presensi/detail/' . $row['NIS'] . '', 'Detail', 'class="label label-info" title="Detail Presensi"') ?>
