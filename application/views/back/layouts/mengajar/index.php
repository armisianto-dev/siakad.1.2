        ...
        <div class="box">
            <div class="box-header">
                ...
                foreach ($user_groups as $value) {
                    if($value->name=="admin"){?>
                <a style="height:100%;padding:9px 10px;" class="btn btn-sm btn-primary btn-flat pull-right" href="<?= site_url('mengajar/add') ?>"><span class="fa fa-plus-square"></span>&nbsp;Tambah</a>
                <?php }} ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="pull-right">
                                        <?= anchor('mengajar/edit/' . $row['ID'] . '', 'Edit', 'class="label label-warning" title="Edit Mengajar"') ?>
                                    </span>
                                </td>
                                <?php }} ?>
                            </tr>
